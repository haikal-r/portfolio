...
export default function ContactPage() {
  ...
  return (
    <section className="flex h-full w-full items-center p-5">
      <FadeIn className="fle-1 max-w-lg">
        <div className="mb-5">
          <h3 className="text-lg">Lets get in touch.</h3>
          <p className="text-muted-foreground text-sm">{`// Let's talk about your projects`}</p>
        </div>
